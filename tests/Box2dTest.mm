...
-(id) init
{
	if( (self=[super init])) {
		...
		CCSpriteBatchNode *parent = [[CCSpriteBatchNode alloc] initWithFile: @"blocks.png" capacity:100];
...
-(void) createResetButton
{
	CCMenuItemImage *reset = [[CCMenuItemImage alloc] initWithNormalImage: @"r1.png"
	...
	CCMenu *menu = [[CCMenu alloc] initWithArray: [NSArray arrayWithObjects: reset, nil]];
...
-(void) addNewSpriteAtPosition:(CGPoint)p
{
	...
	CCNode *parent = _parentNode;

	//We have a 64x64 sprite sheet with 4 different 32x32 images.  The following code is
	//just randomly picking one of the images
	int idx = (CCRANDOM_0_1() > .5 ? 0:1);
	int idy = (CCRANDOM_0_1() > .5 ? 0:1);
	PhysicsSprite *sprite = [[PhysicsSprite alloc] initWithTexture: spriteTexture_
