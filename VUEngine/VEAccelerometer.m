...
@implementation VEAccelerometer;

+ (void)zero
{
    s_calibration = [[[VUEngine motionManager] accelerometerData] acceleration];
}

+ (float)horizontalForOrientation: (UIInterfaceOrientation)orientation
{
    CMAcceleration accel = [[[VUEngine motionManager] accelerometerData] acceleration];
